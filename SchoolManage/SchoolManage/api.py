...
def adminAddStu(req : HttpRequest):
    ...
    if stu != None:
        ...
        res = models.Student.insert(req.POST.get('id'), req.POST.get('name'), req.POST.get('password'),
                                    req.POST.get('gender'), req.POST.get('age'),  #  int(req.POST.get('grade_id')),
...
def adminAddIns(req : HttpRequest):
    ...
    if ins != None:
        ...
        res = models.Instructor.insert(req.POST.get('id'), req.POST.get('name'), req.POST.get('password'),
...
def adminAddGrade(req : HttpRequest):
    ...
    if grade != None:
        ...
        res = models.Grade.insert(req.POST.get('id'), req.POST.get('name'))
        if res['succeed']:
            result = True
    return HttpResponse(json.dumps({'succeed': result, 'msg': msg}))
...
def adminEditStu(req: HttpRequest):
    ...
    if stu is None:
        ...
        res = models.Student.updateS(req.POST.get('id'), req.POST.get('name'), req.POST.get('password'),
                                    req.POST.get('gender'), req.POST.get('age'),   # int(req.POST.get('grade_id')),
                                    int(req.POST.get('ins_id')))
    return HttpResponse(json.dumps({'succeed': result, 'msg': msg}))
...
def adminEditIns(req : HttpRequest):
    ...
    if ins is None:
        ...
        res = models.Instructor.updateI(req.POST.get('id'), req.POST.get('name'), req.POST.get('password'),
                                       req.POST.get('gender'), req.POST.get('tele'), int(req.POST.get('grade_id')))
...
def adminEditGrade(req : HttpRequest):
    ...
    if grade is None:
        ...
        res = models.Grade.updateG(req.POST.get('id'), req.POST.get('name'))
