...
class Student:
    ...
    @staticmethod
    def insert(id, name, password, gender, age, grade_id, ins_id):
        result = database.doInsert("insert into student values('{0}', '{1}', '{2}', '{3}', '{4}', '{5}', '{6}', '{7}')".format(id, name, password, gender, 0, age, grade_id, ins_id))
        return result

    @staticmethod
    def updateS(id, name, password, gender, age, grade_id, ins_id):
        result = database.doUpdate("update student set stu_name='{0}', stu_password='{1}', stu_gender='{2}', stu_age='{3}', stu_grade_id='{4}', stu_ins_id='{5}' where stu_id={6}".format(name, password, gender, age, grade_id, ins_id, id))
        return result['succeed']
